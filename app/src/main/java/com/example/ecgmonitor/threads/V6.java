...
public class V6 extends Thread{
    ...
    public V6(LineChart lineChart, Context context, BluetoothData bluetoothData) {
        ...
        mLineChart.getDescription().setText("V6");
    ...
    public void run() {
        ...
        while (!isStopped) {
            ...
            if(row.length>11 && isNumeric(row[11])) {
                float column11 = Float.parseFloat(row[11]);
                addCSVEntry(column11);
            }
