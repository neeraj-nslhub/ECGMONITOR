...
public class AVF extends Thread{
    ...
    public AVF(LineChart lineChart, Context context, BluetoothData bluetoothData) {
        ...
        mLineChart.getDescription().setText("aVF");
    ...
    public void run() {
        ...
        while (!isStopped) {
            ...
            if(row.length>5 && isNumeric(row[5])) {
