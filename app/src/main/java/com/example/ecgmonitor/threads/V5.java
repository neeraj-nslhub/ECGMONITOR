...
public class V5 extends Thread{
    private BluetoothData mData;
    private InputStream mInputStream;
    private LineChart mLineChart;
    private Context mContext;
    private volatile boolean isStopped = false;
    public V5(LineChart lineChart, Context context, BluetoothData bluetoothData) {
        ...
        mLineChart.getDescription().setText("V5");
    ...
    public void run() {
        ...
        while (!isStopped) {
            ...
            if(row.length>10 && isNumeric(row[10])) {
                float column10 = Float.parseFloat(row[10]);
                addCSVEntry(column10);
            }
