...
public class Lead3 extends Thread{
    private BluetoothData mData;
    private InputStream mInputStream;
    private LineChart mLineChart;
    private Context mContext;
    private volatile boolean isStopped = false;
    public Lead3(LineChart lineChart, Context context, BluetoothData bluetoothData) {
        ...
        mLineChart.getDescription().setText("lead III");
    ...
    public void run() {
        ...
        while (!isStopped) {
            ...
            if(row.length>2 && isNumeric(row[2])) {
