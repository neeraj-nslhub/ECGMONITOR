...
public class LeadThreeLineChart extends Thread {
    ...
    public LeadThreeLineChart(LineChart lineChart, Context context, BluetoothData bluetoothData) {
        ...
        mLineChart.getDescription().setText("Lead 3");
    ...
    public void run() {
        ...
        while (true) {
            ...
            int column0 = Integer.parseInt(row[2]);
            addCSVEntry(column0);
