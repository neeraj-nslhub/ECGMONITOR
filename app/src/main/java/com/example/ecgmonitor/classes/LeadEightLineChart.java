...
public class LeadEightLineChart extends Thread{
    ...
    public LeadEightLineChart(LineChart lineChart, Context context, BluetoothData bluetoothData) {
        ...
        mLineChart.getDescription().setText("Lead 8");
    ...
    public void run() {
        ...
        while (true) {
            ...
            int column0 = Integer.parseInt(row[7]);
            addCSVEntry(column0);
