...
public class LeadSevenLineChart extends Thread{
    ...
    public LeadSevenLineChart(LineChart lineChart, Context context, BluetoothData bluetoothData) {
        ...
        mLineChart.getDescription().setText("Lead 7");
    ...
    public void run() {
        ...
        while (true) {
            ...
            int column0 = Integer.parseInt(row[6]);
            addCSVEntry(column0);
