...
public class LeadNineLineChart extends Thread{
    ...
    public LeadNineLineChart(LineChart lineChart, Context context, BluetoothData bluetoothData) {
        ...
        mLineChart.getDescription().setText("Lead 9");
    ...
    public void run() {
        ...
        while (true) {
            ...
            int column0 = Integer.parseInt(row[8]);
            addCSVEntry(column0);
