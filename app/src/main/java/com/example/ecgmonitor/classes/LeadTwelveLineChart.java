...
public class LeadTwelveLineChart extends Thread{
    ...
    public LeadTwelveLineChart(LineChart lineChart, Context context, BluetoothData bluetoothData) {
        ...
        mLineChart.getDescription().setText("Lead 12");
    ...
    public void run() {
        ...
        while (true) {
            ...
            int column0 = Integer.parseInt(row[11]);
            addCSVEntry(column0);
