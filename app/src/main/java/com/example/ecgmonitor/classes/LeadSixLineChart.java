...
public class LeadSixLineChart extends Thread{
    ...
    public LeadSixLineChart(LineChart lineChart, Context context, BluetoothData bluetoothData) {
        ...
        mLineChart.getDescription().setText("Lead 6");
    ...
    public void run() {
        ...
        while (true) {
            ...
            int column0 = Integer.parseInt(row[5]);
            addCSVEntry(column0);
