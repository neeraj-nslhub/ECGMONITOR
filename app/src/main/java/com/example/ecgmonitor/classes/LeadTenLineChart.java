...
public class LeadTenLineChart extends Thread{
    ...
    public LeadTenLineChart(LineChart lineChart, Context context, BluetoothData bluetoothData) {
        ...
        mLineChart.getDescription().setText("Lead 10");
    ...
    public void run() {
        ...
        while (true) {
            ...
            int column0 = Integer.parseInt(row[9]);
            addCSVEntry(column0);
