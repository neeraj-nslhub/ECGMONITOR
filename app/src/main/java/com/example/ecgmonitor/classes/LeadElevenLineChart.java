...
public class LeadElevenLineChart extends Thread{
    ...
    public LeadElevenLineChart(LineChart lineChart, Context context, BluetoothData bluetoothData) {
    ...
    public void run() {
        ...
        while (true) {
            ...
            int column0 = Integer.parseInt(row[10]);
            addCSVEntry(column0);
