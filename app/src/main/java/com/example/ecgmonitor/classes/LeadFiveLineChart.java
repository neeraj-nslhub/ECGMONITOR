...
public class LeadFiveLineChart extends Thread{
    ...
    public LeadFiveLineChart(LineChart lineChart, Context context, BluetoothData bluetoothData) {
        ...
        mLineChart.getDescription().setText("Lead 5");
    ...
    public void run() {
        ...
        while (true) {
            ...
            int column0 = Integer.parseInt(row[4]);
            addCSVEntry(column0);
