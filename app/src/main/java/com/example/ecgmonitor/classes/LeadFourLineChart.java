...
public class LeadFourLineChart extends Thread {
    ...
    public LeadFourLineChart(LineChart lineChart, Context context, BluetoothData bluetoothData) {
        ...
        mLineChart.getDescription().setText("Lead 4");
    ...
    public void run() {
        ...
        while (true) {
            ...
            int column0 = Integer.parseInt(row[3]);
            addCSVEntry(column0);
